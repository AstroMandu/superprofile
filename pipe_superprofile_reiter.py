...
def task_main(g):
    ...
    for i,ii in enumerate(g['iterables']):
        ...
        if g['guess_from_prev']:
            if i==0: 
                if 'preguess' in g:
                    plotfit.dict_preguess = g['preguess']
            else:
                ...
                if len(df_GFIT)!=1: 
                    ...
                    print(df_GFIT)
                    raise
                params = df_GFIT.loc[0,['A1','A31','A32','A33','V31','V32','V33','S31','S32','S33','B3']]
                if    params.isna().any(): pass
                else: 
                    A1,A31,A32,A33,V31,V32,V33,S31,S32,S33,B3 = params
                    plotfit.dict_preguess = {
                        'A31': A31,'A32': A32,'A33': A33,
                        'V31': V31,'V32': V32,'V33': V33,
                        'S31': S31,'S32': S32,'S33': S33,
                        'B3' : B3
                    }
            # Atot = plotfit.dict_preguess['A31']+plotfit.dict_preguess['A32']+plotfit.dict_preguess['A33']
            # if plotfit.dict_preguess['A33']/Atot<0.01:
            #     plotfit.dict_preguess['S33']=1e10
            #     print('preguess: putting S33=large')
...
if __name__=='__main__':
    ...
    dict_dict_preguess = {
        'BAYMOM_AVID':{
            # 'AGC225847_W120':{'start_from':'_A180_W120','itereverse':0},
            #    'VCC130_W120':{'start_from':'_A135_W120','itereverse':0},
            #    'VCC152_W120':{'start_from':'_A285_W120','itereverse':0},
            #    'VCC169_W120':{'start_from':'_A090_W120','itereverse':0},
            #    'VCC309_W120':{'start_from':'_A135_W120','itereverse':0},
            #    'VCC322_W120':{'start_from':'_A000_W120','itereverse':0},
            #    'VCC328_W120':{'start_from':'_A075_W120','itereverse':0},
            #    'VCC329_W120':{'start_from':'_A000_W120','itereverse':0},
            #    'VCC334_W120':{'start_from':'_A225_W120','itereverse':0},
            #    'VCC340_W120':{'start_from':'_A000_W120','itereverse':0},
            #    'VCC379_W120':{'start_from':'_A135_W120','itereverse':0},
            #    'VCC381_W120':{'start_from':'_A000_W120','itereverse':0},
            #    'VCC566_W120':{'start_from':'_A090_W120','itereverse':0},
            #    'VCC613_W120':{'start_from':'_A000_W120','itereverse':0},
            #    'VCC656_W120':{'start_from':'_A225_W120','itereverse':0},
            ...
            #    'VCC699_W120':{'start_from':'_A180_W120','itereverse':0},
            ...
            #   'VCC2006_W120':{'start_from':'_A135_W120','itereverse':0},
            #   'VCC2034_W120':{'start_from':'_A180_W120','itereverse':0},
            #   'VCC2037_W120':{'start_from':'_A000_W120','itereverse':0},
            
            # 'AGC225847_W180':{'start_from':'_A105_W180','itereverse':0},
            #    'VCC130_W180':{'start_from':'_A315_W180','itereverse':0},
            #    'VCC152_W180':{'start_from':'_A270_W180','itereverse':0},
            #    'VCC169_W180':{'start_from':'_A270_W180','itereverse':0},
            #    'VCC309_W180':{'start_from':'_A135_W180','itereverse':0},
            #    'VCC322_W180':{'start_from':'_A135_W180','itereverse':0},
            #    'VCC328_W180':{'start_from':'_A090_W180','itereverse':0},
            #    'VCC329_W180':{'start_from':'_A195_W180','itereverse':0},
            #    'VCC331_W180':{'start_from':'_A000_W180','itereverse':0},
            #    'VCC334_W180':{'start_from':'_A015_W180','itereverse':0},
            #    'VCC340_W180':{'start_from':'_A315_W180','itereverse':0},
            #    'VCC379_W180':{'start_from':'_A315_W180','itereverse':0},
            #    'VCC381_W180':{'start_from':'_A270_W180','itereverse':0},
            #    'VCC566_W180':{'start_from':'_A270_W180','itereverse':0},
            #    'VCC613_W180':{'start_from':'_A045_W180','itereverse':0},
            #    'VCC656_W180':{'start_from':'_A000_W180','itereverse':0},
            #    'VCC667_W180':{'start_from':'_A000_W180','itereverse':0},
            #    'VCC693_W180':{'start_from':'_A000_W180','itereverse':0},
            #    'VCC697_W180':{'start_from':'_A135_W180','itereverse':0},
            #    'VCC699_W180':{'start_from':'_A090_W180','itereverse':0},
            #   'VCC1091_W180':{'start_from':'_A000_W180','itereverse':0},
            #   'VCC1411_W180':{'start_from':'_A000_W180','itereverse':0},
            #   'VCC1778_W180':{'start_from':'_A345_W180','itereverse':1},
            #   'VCC1992_W180':{'start_from':'_A090_W180','itereverse':0},
            #   'VCC2006_W180':{'start_from':'_A135_W180','itereverse':0},
            #   'VCC2034_W180':{'start_from':'_A135_W180','itereverse':0},
            #   'VCC2037_W180':{'start_from':'_A180_W180','itereverse':0},

        },
        'BAYMOM_LT':{
            # 'CVnIdwA_W120': {'start_from':'_A000_W120'},
            'DDO43_W120':   {'start_from':'_A195_W120'},
            # 'DDO46_W120':   {'start_from':'_A000_W120'},
            # 'DDO47_W120':   {'start_from':'_A000_W120'},
            'DDO50_W120':   {'start_from':'_A270_W120'},
            # 'DDO52_W120':   {'start_from':'_A000_W120'},
            'DDO53_W120':   {'start_from':'_A180_W120'},
            # 'DDO63_W120':   {'start_from':'_A000_W120'},
            'DDO69_W120':   {'start_from':'_A315_W120'},
            # 'DDO70_W120':   {'start_from':'_A000_W120'},
            # 'DDO75_W120':   {'start_from':'_A000_W120'},
            # 'DDO87_W120':   {'start_from':'_A000_W120'},
            # 'DDO101_W120':  {'start_from':'_A135_W120'},
            # 'DDO126_W120':  {'start_from':'_A135_W120'},
            # 'DDO133_W120':  {'start_from':'_A000_W120'},
            'DDO154_W120':  {'start_from':'_A225_W120'},
            'DDO155_W120':  {'start_from':'_A315_W120'},
            # 'DDO165_W120':  {'start_from':'_A045_W120'},
            'DDO167_W120':  {'start_from':'_A315_W120'},
            # 'DDO168_W120':  {'start_from':'_A000_W120'},
            # 'DDO187_W120':  {'start_from':'_A090_W120'},
            # 'DDO210_W120':  {'start_from':'_A225_W120'},
            # 'DDO216_W120':  {'start_from':'_A000_W120'},
            # 'F564-V3_W120': {'start_from':'_A000_W120'},
            # 'Haro29_W120':  {'start_from':'_A045_W120'},
            # 'Haro36_W120':  {'start_from':'_A225_W120'},
            # 'IC10_W120':    {'start_from':'_A000_W120'},
            # 'IC1613_W120':  {'start_from':'_A135_W120'},
            # 'LGS3_W120':    {'start_from':'_A000_W120'},
            # 'M81DWA_W120':  {'start_from':'_A045_W120'},
            # 'Mrk178_W120':  {'start_from':'_A000_W120'},
            # 'NGC1569_W120': {'start_from':'_A000_W120'},
            # 'NGC2366_W120': {'start_from':'_A000_W120'},
            # 'NGC3738_W120': {'start_from':'_A180_W120'},
            # 'NGC4163_W120': {'start_from':'_A090_W120'},
            # 'NGC4214_W120': {'start_from':'_A000_W120'},
            # 'SAGDIG_W120':  {'start_from':'_A000_W120'},
            # 'UGC8508_W120': {'start_from':'_A135_W120'},
            # 'VIIZw403_W120':{'start_from':'_A090_W120'},
            # 'WLM_W120':     {'start_from':'_A000_W120'},
        },
        'W180_BAY':{
            'AGC225847':'_A090_W180',
            'VCC130':   '_A090_W180',
            'VCC152':   '_A315_W180',
            'VCC169':   '_A180_W180',
            'VCC309':   '_A090_W180',
        ...
        'BAYMOM_Rory':{
            'snap00_W060':{'start_from':'_A270_W060'},
            'snap09_W060':{'start_from':'_A270_W060'},
            'snap10_W060':{'start_from':'_A270_W060'},
            'snap13_W060':{'start_from':'_A270_W060'},
            'snap00_W120':{'start_from':'_A270_W120'},
            'snap09_W120':{'start_from':'_A270_W120'},
            'snap10_W120':{'start_from':'_A270_W120'},
            'snap13_W120':{'start_from':'_A270_W120'},
        },
        'HERMOM':{
            # 'CVnIdwA_W120': {'start_from':'_A180_W120'},
            # 'DDO43_W120':   {'start_from':'_A000_W120'},
            'DDO46_W120':   {'start_from':'_A045_W120'},
            'DDO47_W120':   {'start_from':'_A000_W120'},
            'DDO50_W120':   {'start_from':'_A000_W120'},
            'DDO52_W120':   {'start_from':'_A315_W120'},
            'DDO53_W120':   {'start_from':'_A180_W120'},
            'DDO63_W120':   {'start_from':'_A000_W120'},
            'DDO69_W120':   {'start_from':'_A000_W120'},
            'DDO70_W120':   {'start_from':'_A000_W120'},
            'DDO75_W120':   {'start_from':'_A180_W120'},
            'DDO87_W120':   {'start_from':'_A270_W120'},
            'DDO101_W120':  {'start_from':'_A090_W120'},
            'DDO126_W120':  {'start_from':'_A180_W120'},
            'DDO133_W120':  {'start_from':'_A000_W120'},
            'DDO154_W120':  {'start_from':'_A000_W120'},
            'DDO155_W120':  {'start_from':'_A000_W120'},
            'DDO165_W120':  {'start_from':'_A000_W120'},
            'DDO167_W120':  {'start_from':'_A000_W120'},
            'DDO168_W120':  {'start_from':'_A180_W120'},
            'DDO187_W120':  {'start_from':'_A000_W120'},
            'DDO210_W120':  {'start_from':'_A225_W120'},
            'DDO216_W120':  {'start_from':'_A000_W120'},
            'F564-V3_W120': {'start_from':'_A000_W120'},
            'Haro29_W120':  {'start_from':'_A000_W120'},
            'Haro36_W120':  {'start_from':'_A120_W120'},
            'IC10_W120':    {'start_from':'_A000_W120'},
            'IC1613_W120':  {'start_from':'_A000_W120'},
            'LGS3_W120':    {'start_from':'_A180_W120'},
            'M81DWA_W120':  {'start_from':'_A000_W120'},
            'Mrk178_W120':  {'start_from':'_A000_W120'},
            'NGC1569_W120': {'start_from':'_A030_W120'},
            'NGC2366_W120': {'start_from':'_A195_W120'},
            'NGC3738_W120': {'start_from':'_A000_W120'},
            'NGC4163_W120': {'start_from':'_A000_W120'},
            'NGC4214_W120': {'start_from':'_A000_W120'},
            'SAGDIG_W120':  {'start_from':'_A090_W120'},
            'UGC8508_W120': {'start_from':'_A000_W120'},
        ...
        'HERMOM_alt':{
            # 'CVnIdwA_W120': {'start_from':'_A180_W120'},
            # 'DDO43_W120':   {'start_from':'_A000_W120'},
            'DDO46_W120':   {'start_from':'_A225_W120'},
            # 'DDO47_W120':   {'start_from':'_A000_W120'},
            # 'DDO50_W120':   {'start_from':'_A000_W120'},
            # 'DDO52_W120':   {'start_from':'_A315_W120'},
            'DDO53_W120':   {'start_from':'_A090_W120'},
            'DDO63_W120':   {'start_from':'_A180_W120'},
            'DDO69_W120':   {'start_from':'_A090_W120'},
            'DDO70_W120':   {'start_from':'_A270_W120'},
            'DDO75_W120':   {'start_from':'_A345_W120'},
            # 'DDO87_W120':   {'start_from':'_A270_W120'},
            # 'DDO101_W120':  {'start_from':'_A090_W120'},
            'DDO126_W120':  {'start_from':'_A270_W120'},
            'DDO133_W120':  {'start_from':'_A225_W120'},
            'DDO154_W120':  {'start_from':'_A135_W120'},
            'DDO155_W120':  {'start_from':'_A135_W120'},
            'DDO165_W120':  {'start_from':'_A180_W120'},
            'DDO167_W120':  {'start_from':'_A180_W120'},
            # 'DDO168_W120':  {'start_from':'_A180_W120'},
            'DDO187_W120':  {'start_from':'_A240_W120'},
            'DDO210_W120':  {'start_from':'_A135_W120'},
            # 'DDO216_W120':  {'start_from':'_A000_W120'},
            'F564-V3_W120': {'start_from':'_A090_W120'},
            # 'Haro29_W120':  {'start_from':'_A000_W120'},
            # 'Haro36_W120':  {'start_from':'_A120_W120'},
            'IC10_W120':    {'start_from':'_A135_W120'},
            'IC1613_W120':  {'start_from':'_A315_W120'},
            'LGS3_W120':    {'start_from':'_A270_W120'},
            'M81DWA_W120':  {'start_from':'_A315_W120'},
            'Mrk178_W120':  {'start_from':'_A150_W120'},
            # 'NGC1569_W120': {'start_from':'_A030_W120'},
            'NGC2366_W120': {'start_from':'_A120_W120'},
            'NGC3738_W120': {'start_from':'_A285_W120'},
            # 'NGC4163_W120': {'start_from':'_A000_W120'},
            'NGC4214_W120': {'start_from':'_A090_W120'},
            'SAGDIG_W120':  {'start_from':'_A270_W120'},
            # 'UGC8508_W120': {'start_from':'_A000_W120'},
            'VIIZw403_W120':{'start_from':'_A075_W120'},
            'WLM_W120':     {'start_from':'_A060_W120'},
        }
    }
    ...
    path_output_source = Path('/home/mskim/workspace/research/data/LITTLE_THINGS_REG_3GFIT_BAYMOM')
    paths_cube =         Path('/home/mskim/workspace/research/data/LITTLE_THINGS_REG').glob('*/cube.fits')
    
    # stakmode='baygaud'
    # key_preguess = 'BAYMOM_AVID'
    # path_output_source = Path('/home/mskim/workspace/research/data/AVID_hann_REG_3GFIT_BAYMOM')
    # paths_cube =         Path('/home/mskim/workspace/research/data/AVID_hann_REG').glob('*/cube.fits')
    ...
    for key,val in dict_preguess.items():
        ...
        params = df_loc.loc[0,['A1','A31','A32','A33','V31','V32','V33','S31','S32','S33','B3']]
        if params.isna().any():
            dict_jobs[key]['preguess'] = {}
        else: 
            dict_jobs[key]['preguess'] = {
                'A31': params['A31'],'A32': params['A32'],'A33': params['A33'],
                'V31': params['V31'],'V32': params['V32'],'V33': params['V33'],
                'S31': params['S31'],'S32': params['S32'],'S33': params['S33'],
                'B3': params['B3']
            }
        ...
        iterB = np.array([ii for ii in range(0,-181,-15)]) + PA_start_from
        iterB = iterB[1:]
        iterA[iterA>=360] -=360
        iterB[iterB<0]    +=360
